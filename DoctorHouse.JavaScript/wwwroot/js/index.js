...
var settings = {
    ...
    redirect_uri: "https://localhost:9005/callback.html",
    silent_redirect_uri: "https://localhost:9005/refresh.html",
    post_logout_redirect_uri: "https://localhost:9005/index.html"
}
...
function callApi() {
    manager.getUser().then(function (user) {
        ...
        xhr.open("GET", "https://localhost:8001/site/secret");
        xhr.onload = function () {
            if (xhr.status === 200) {
